...
const LPKindWords: React.FC<Props> = ({ className }) => {
  ...
  return (
    <div
      id="kind-words"
      className={cx('py-16 sm:pt-24 bg-gray-100 dark:bg-gray-900', className)}
      style={{
    ...
    >
      <div className="container">
        ...
        <p className="text-xl sm:text-2xl md:text-3xl font-medium text-green-600 mb-12">
          <FormattedMessage
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full md:w-1/2 sm:px-4 space-y-4 md:space-y-8 mb-4 md:mb-0">
            ...
            />
            {/* {<KindMessage
              authorAvatarURL="/assets/kind-words-authors/sabrina.jpeg"
              authorName="Sabrina Zerlini de Sá"
              authorRole="Coordenadora de Comunicação"
